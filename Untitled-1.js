{
  ...
  req: IncomingMessage {
    ...
    headers: {
      ...
      'accept-language': 'en,en-GB;q=0.9,en-US;q=0.8,de-DE;q=0.7,de;q=0.6,es;q=0.5',
    ...
    rawHeaders: [
      ...
      'gzip, deflate, br',
      'Accept-Language',
      'en,en-GB;q=0.9,en-US;q=0.8,de-DE;q=0.7,de;q=0.6,es;q=0.5',
      'Cookie',
      'next-i18next=en',
      'If-None-Match',
    ...
    route: Route { path: '/api/whoami', stack: [Array], methods: [Object] }
  },
